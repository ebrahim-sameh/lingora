...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_20px_-4px_hsl(239_84%_67%/0.5)] hover:shadow-[0_0_30px_-4px_hsl(239_84%_67%/0.7)]',
        gradient:
          'text-white shadow-[0_0_30px_-4px_hsl(239_84%_67%/0.6)] hover:shadow-[0_0_40px_-4px_hsl(270_91%_65%/0.7)] bg-[length:200%_auto] bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 hover:bg-right',
